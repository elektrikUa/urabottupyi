...
img_bullet = "patron.png" # куля
img_enemy = "enemy.png"  # ворог
img_ast = "pock.png" # астероїд
img_heal = "1839198.png"
...
heals = sprite.Group()
for i in range(1,3):
    heal = aster(img_heal, randint(30, win_width - 30), -40, 80, 50, randint(1, 7))
    heals.add(heal)
...
while run:
    ...
    if not finish:
        ...
        if sprite.spritecollide(ship,heals, False):
            sprite.spritecollide(ship, heals, True)
            life = life+1
